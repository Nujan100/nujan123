    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400">
              I am a passionate Full Stack Developer dedicated to creating elegant solutions
              to complex problems. I love building modern web applications and sharing
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://github.com/nujanshrestha"
                target="_blank"
              ...
              <a
                href="https://linkedin.com/in/nujanshrestha"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="https://twitter.com/nujanshrestha"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Nujan Shrestha. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
